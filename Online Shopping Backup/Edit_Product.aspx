...
<body>
    ...
    <div style="height: 300px">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="3" DataKeyNames="P_ID" DataSourceID="SqlDataSource1" GridLines="Vertical" Height="260px" style="margin-bottom: 116px" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px">
