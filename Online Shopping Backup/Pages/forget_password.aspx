        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <div class="form-group">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Answer is required" ControlToValidate="txt_answer"></asp:RequiredFieldValidator>
                </div>
                <div class="form-group">
                    <label>New Password</label>
                    <asp:TextBox CssClass="form-control" ID="txt_new_password" runat="server" TextMode="Password"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="New Password is required" ControlToValidate="txt_new_password"></asp:RequiredFieldValidator>
                </div>
