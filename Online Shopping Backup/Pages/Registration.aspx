        ...
        <div class="row">
            ...
            <div class="col-lg-5">
             ...
             <div class="form-group">
               ...
               <asp:TextBox ID="txt_CPass" CssClass="form-control" runat="server" TextMode="Password" placeholder="Confirm your pasword" ControlToValidate="txt_CPass"></asp:TextBox>

                 <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="Password doesn't match" ControlToCompare="txt_password" ControlToValidate="txt_CPass"></asp:CompareValidator>
             &nbsp; 
              </div>
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txt_answer" placeholder="Enter your Answer" runat="server" CssClass="form-control" TextMode="SingleLine"></asp:TextBox>
                                   ...
                                   <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="Answer is Required" ControlToValidate="txt_address" ForeColor="Red"></asp:RequiredFieldValidator>
                  

                </div>


                <asp:Button CssClass="btn btn-info" ID="btn_submit" runat="server" Text="Submit" OnClick="btn_submit_Click" /> &nbsp &nbsp; &nbsp <a class="login" href ="/Login.aspx" >Already Registered? Click Here to Login</a>
