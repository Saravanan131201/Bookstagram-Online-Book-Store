...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container" style="margin-top: 30px">
                ...
                <asp:DataList ID="DataList3" runat="server" DataSourceID="SqlDataSource3">
                    <ItemTemplate>
                        <ul id="etalage">
                             ...
                             <li>
                        <img id="Img1" class="etalage_thumb_image" runat="server" src='<%# Eval("Brand_image") %>' />
                        <img id="Img2" class="etalage_source_image" runat="server" src='<%# Eval("Brand_image") %>' />

                            </li>
                            
                            <li>
                                <img id="Img3" class="etalage_thumb_image" runat="server" src='<%# Eval("Imagepath1") %>' />
                                <img id="Img4" class="etalage_source_image" runat="server" src='<%# Eval("Imagepath1") %>' />


                            </li>
                            
                            <li>
                                <img id="Img5" class="etalage_thumb_image" runat="server" src='<%# Eval("Imagepath2") %>' />
                                <img id="Img6" class="etalage_source_image" runat="server" src='<%# Eval("Imagepath2") %>' />
                            </li>

                            <li>
                                <img id="Img7" class="etalage_thumb_image" runat="server" src='<%# Eval("Imagepath3") %>' />
                                <img id="Img8" class="etalage_source_image" runat="server" src='<%# Eval("Imagepath3") %>' />
                            </li>

                            <li>

                                <img id="Img9" class="etalage_thumb_image" runat="server" src='<%# Eval("Imagepath4") %>' />
                                <img id="Img10" class="etalage_source_image" runat="server" src='<%# Eval("Imagepath4") %>' />
            ...
            <div class="col-lg-6">
                ...
                <asp:DataList ID="DataList1" runat="server" DataKeyField="P_ID" DataSourceID="SqlDataSource1">
                    ...
                    <ItemTemplate>
                      ...
                      <b>MRP:</b>
                          <del>
                       <asp:Label ID="Label1" runat="server" Text='<%# Eval("MRP") %>' />
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:ShoppingConnectionString %>" SelectCommand="SELECT [Brand_image], [Imagepath1], [Imagepath2], [Imagepath3], [Imagepath4] FROM [main_product] WHERE ([P_ID] = @P_ID)">
            <SelectParameters>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ShoppingConnectionString %>" SelectCommand="SELECT [P_ID], [Product_name], [MRP], [Our_Prize], [Discount],[Brand_image], [Imagepath1], [Imagepath2], [Imagepath3], [Imagepath4],[Brand],[Detail] FROM [main_product] WHERE ([P_ID] = @P_ID)">
        <SelectParameters>
            <asp:QueryStringParameter Name="P_ID" QueryStringField="P_ID" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
