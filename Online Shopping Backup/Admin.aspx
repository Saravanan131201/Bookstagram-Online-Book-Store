    ...
    <div class="container">
                ...
                <div id="div1">
                    <div class="list">
                        <ul>
                            ...
                            <li>
                                <asp:Button CssClass="btn btn-primary" Height="48px" ID="Button3" runat="server" Text="Add Book" OnClick="btn_Add_Product_Click" />
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <ul>
                ...
                <li>
                    <asp:Button CssClass="btn btn-primary" ID="Button4" Height="48px" runat="server" Text="Edit Book" OnClick="btn_Edit_Product_Click" />

                </li>


                <li>
                    <asp:Button CssClass="btn btn-primary" ID="Button5" Height="48px" runat="server" Text="Delete Book" OnClick="btn_delete_Product_Click" />
